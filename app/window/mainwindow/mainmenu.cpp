...
MainMenu::MainMenu(MainWindow* parent) : QMenuBar(parent) {
  ...
  file_project_properties_item_ =
      file_menu_->AddItem("projectproperties", Core::instance(), &Core::DialogProjectPropertiesShow);
  file_menu_->addSeparator();
  file_close_project_item_ = file_menu_->AddItem("closeproj", Core::instance(), &Core::CloseActiveProject);
  file_close_all_projects_item_ =
      file_menu_->AddItem("closeallproj", Core::instance(), static_cast<bool (Core::*)()>(&Core::CloseAllProjects));
  file_close_all_except_item_ =
      file_menu_->AddItem("closeallexcept", Core::instance(), &Core::CloseAllExceptActiveProject);
  file_menu_->addSeparator();
  ...
  edit_ripple_delete_inout_item_ =
      edit_menu_->AddItem("rippledeleteinout", this, &MainMenu::RippleDeleteInOutTriggered, "'");
  edit_menu_->addSeparator();
  ...
  view_increase_track_height_item_ =
      view_menu_->AddItem("vzoomin", this, &MainMenu::IncreaseTrackHeightTriggered, "Ctrl+=");
  view_decrease_track_height_item_ =
      view_menu_->AddItem("vzoomout", this, &MainMenu::DecreaseTrackHeightTriggered, "Ctrl+-");
  ...
  view_timecode_view_nondropframe_item_ =
      view_menu_->AddItem("modenondropframe", this, &MainMenu::TimecodeDisplayTriggered);
  ...
  view_timecode_view_milliseconds_item_ =
      view_menu_->AddItem("milliseconds", this, &MainMenu::TimecodeDisplayTriggered);
  ...
  playback_playinout_item_ =
      playback_menu_->AddItem("playintoout", this, &MainMenu::PlayInToOutTriggered, "Shift+Space");
  ...
  window_lock_layout_item_ =
      window_menu_->AddItem("lockpanels", PanelManager::instance(), &PanelManager::SetPanelsLocked);
...
void MainMenu::PlaybackMenuAboutToShow() { playback_loop_item_->setChecked(Config::Current()["Loop"].toBool()); }
...
void MainMenu::LoopTriggered(bool enabled) { Config::Current()["Loop"] = enabled; }
