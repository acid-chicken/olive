...
void MainWindow::closeEvent(QCloseEvent* e) {
  if (isWindowModified()) {
    ...
    if (mb.clickedButton() == cancel_btn || (mb.clickedButton() == yes_btn && !Core::instance()->SaveActiveProject())) {
  ...
  foreach (ViewerPanelBase* viewer, viewers) { viewer->ConnectViewerNode(nullptr); }
