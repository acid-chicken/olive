...
class Node : public QObject {
 ...
 public:
   ...
   */
  void Load(QXmlStreamReader* reader, QHash<quintptr, NodeOutput*>& param_ptrs,
            QList<NodeInput::SerializedConnection>& input_connections,
            QList<NodeParam::FootageConnection>& footage_connections, const QString& element = QString());
   ...
   */
  virtual void ProcessSamples(const NodeValueDatabase* values, const AudioRenderingParams& params, const float* input,
  ...
  /**
   * @brief For a list of copies nodes, this function will duplicate all the connections in the source list to the
   * destination list
   */
