...
Node *VolumeNode::copy() const { return new VolumeNode(); }
...
QString VolumeNode::Category() const { return tr("Audio"); }

QString VolumeNode::Description() const { return tr("Adjusts the volume of an audio source."); }

Node::Capabilities VolumeNode::GetCapabilities(const NodeValueDatabase &) const { return kSampleProcessor; }

NodeInput *VolumeNode::ProcessesSamplesFrom(const NodeValueDatabase &value) const { return samples_input_; }

void VolumeNode::ProcessSamples(const NodeValueDatabase &values, const AudioRenderingParams &params,
...
NodeInput *VolumeNode::samples_input() const { return samples_input_; }
