...
QString VolumeNode::id() const { return "org.olivevideoeditor.Olive.volume"; }
...
NodeInput *VolumeNode::ProcessesSamplesFrom() const { return samples_input_; }

void VolumeNode::ProcessSamples(const NodeValueDatabase *values, const AudioRenderingParams &params, const float *input,
