...
NodeMetaReader::NodeMetaReader(const QString &xml_meta_filename)
    : xml_filename_(xml_meta_filename), iterations_(1), iteration_input_(nullptr) {
...
QString NodeMetaReader::Name() const { return GetStringForCurrentLanguage(&names_); }
...
const QString &NodeMetaReader::id() const { return id_; }

QString NodeMetaReader::Category() const { return GetStringForCurrentLanguage(&categories_); }

QString NodeMetaReader::Description() const { return GetStringForCurrentLanguage(&descriptions_); }

const QString &NodeMetaReader::filename() const { return xml_filename_; }

const QString &NodeMetaReader::frag_code() const { return frag_code_; }

const QString &NodeMetaReader::vert_code() const { return vert_code_; }

const int &NodeMetaReader::iterations() const { return iterations_; }

NodeInput *NodeMetaReader::iteration_input() const { return iteration_input_; }

const QList<NodeInput *> &NodeMetaReader::inputs() const { return inputs_; }
