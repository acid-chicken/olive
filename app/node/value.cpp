...
NodeValueTable NodeValueDatabase::operator[](const QString &input_id) const { return tables_.value(input_id); }

NodeValueTable NodeValueDatabase::operator[](const NodeInput *input) const { return tables_.value(input->id()); }
