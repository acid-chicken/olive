...
TimeBasedPanel::TimeBasedPanel(QWidget *parent) : PanelWidget(parent), widget_(nullptr) {}
...
void TimeBasedPanel::SetTime(const int64_t &timestamp) { widget_->SetTime(timestamp); }
