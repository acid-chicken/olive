...
PreferencesBehaviorTab::PreferencesBehaviorTab() {
  ...
  AddItem(tr("Enable hover focus"), QStringLiteral("HoverFocus"),
          ...
          general_group);
  AddItem(tr("Scroll wheel zooms by default instead of scrolling"), QStringLiteral("ScrollZooms"),
          tr("Holding CTRL while using Olive toggles this setting"), general_group);
  ...
  AddItem(tr("Seek Also Selects"), QStringLiteral("SelectAlsoSeeks"), timeline_group);
