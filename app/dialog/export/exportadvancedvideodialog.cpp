...
ExportAdvancedVideoDialog::ExportAdvancedVideoDialog(QWidget* parent) : QDialog(parent) {
...
int ExportAdvancedVideoDialog::threads() const { return static_cast<int>(thread_slider_->GetValue()); }

void ExportAdvancedVideoDialog::set_threads(int t) { thread_slider_->SetValue(t); }
