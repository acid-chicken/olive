...
class ExportFormat {
 public:
  ExportFormat(const QString& name, const QString& extension, const QString& encoder, const QList<int>& vcodecs,
               const QList<int>& acodecs)
      : name_(name), extension_(extension), encoder_(encoder), video_codecs_(vcodecs), audio_codecs_(acodecs) {}
