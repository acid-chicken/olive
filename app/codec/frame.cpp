...
const int &Frame::width() const { return width_; }

void Frame::set_width(const int &width) { width_ = width; }

const int &Frame::height() const { return height_; }

void Frame::set_height(const int &height) { height_ = height; }
...
const AudioRenderingParams &Frame::audio_params() const { return audio_params_; }

void Frame::set_audio_params(const AudioRenderingParams &params) { audio_params_ = params; }
...
const PixelFormat::Format &Frame::format() const { return format_; }

void Frame::set_format(const PixelFormat::Format &format) { format_ = format; }

QByteArray Frame::ToByteArray() const { return data_; }

const int &Frame::sample_count() const { return sample_count_; }

void Frame::set_sample_count(const int &audio_sample_count) { sample_count_ = audio_sample_count; }
