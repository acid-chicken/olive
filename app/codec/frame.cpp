...
void Frame::set_video_params(const VideoRenderingParams &params) { params_ = params; }

const int &Frame::width() const { return params_.width(); }

const int &Frame::height() const { return params_.height(); }
