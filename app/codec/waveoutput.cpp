...
WaveOutput::WaveOutput(const QString &f, const AudioRenderingParams &params) : file_(f), params_(params) {
  Q_ASSERT(params_.is_valid());
}

WaveOutput::~WaveOutput() { close(); }
...
const int &WaveOutput::data_length() const { return data_length_; }

const AudioRenderingParams &WaveOutput::params() const { return params_; }
