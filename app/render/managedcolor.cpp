...
ManagedColor::ManagedColor(const float &r, const float &g, const float &b, const float &a) : Color(r, g, b, a) {}

ManagedColor::ManagedColor(const char *data, const PixelFormat::Format &format) : Color(data, format) {}
