...
void VideoRenderBackend::CloseInternal() { cache_frame_load_buffer_.clear(); }
...
void VideoRenderBackend::ResizeCacheLoadBuffer() {
  cache_frame_load_buffer_.resize(
      PixelService::GetBufferSize(params_.format(), params_.effective_width(), params_.effective_height()));
}
