...
class RenderWorker : public QObject, public NodeTraverser {
 ...
 signals:
  ...
  void FootageUnavailable(OLIVE_NAMESPACE::StreamPtr stream, OLIVE_NAMESPACE::Decoder::RetrieveState state,
                          const OLIVE_NAMESPACE::TimeRange& range, const OLIVE_NAMESPACE::rational& stream_time);
 ...
 protected:
  ...
  virtual void ProcessNodeEvent(const Node* node, const TimeRange& range, NodeValueDatabase& input_params,
