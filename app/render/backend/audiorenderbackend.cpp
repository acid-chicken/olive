...
AudioRenderBackend::AudioRenderBackend(QObject *parent) : RenderBackend(parent), ic_from_conform_(false) {
...
const AudioRenderingParams &AudioRenderBackend::params() const { return params_; }
...
void AudioRenderBackend::ConformUnavailable(StreamPtr stream, TimeRange range, rational stream_time,
