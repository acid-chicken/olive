...
ColorProcessor::ColorProcessor(OCIO::ConstConfigRcPtr config, const QString& source_space, const QString& dest_space) {
  processor = config->getProcessor(source_space.toUtf8(), dest_space.toUtf8());
}

ColorProcessor::ColorProcessor(OCIO::ConstConfigRcPtr config, const QString& source_space, QString display,
...
ColorProcessorPtr ColorProcessor::Create(OCIO::ConstConfigRcPtr config, const QString& source_space,
...
OpenColorIO::v1::ConstProcessorRcPtr ColorProcessor::GetProcessor() { return processor; }
