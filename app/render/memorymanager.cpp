...
void MemoryManager::CreateInstance() { instance_ = new MemoryManager(); }

MemoryManager* MemoryManager::instance() { return instance_; }
...
bool MemoryManager::ShouldFreeMemory() { return (GetAvailableMemory() < minimum_available_memory_); }
