...
const QString &ColorManager::GetConfigFilename() const { return config_filename_; }
...
void ColorManager::SetDefaultInputColorSpaceInternal(const QString &s) { default_input_color_space_ = s; }
...
void ColorManager::DisassociateAlpha(FramePtr f) { AssociateAlphaPixFmtFilter(kDisassociate, f); }

void ColorManager::AssociateAlpha(FramePtr f) { AssociateAlphaPixFmtFilter(kAssociate, f); }

void ColorManager::ReassociateAlpha(FramePtr f) { AssociateAlphaPixFmtFilter(kReassociate, f); }
...
QStringList ColorManager::ListAvailableInputColorspaces() { return ListAvailableInputColorspaces(config_); }

const QString &ColorManager::GetDefaultInputColorSpace() const { return default_input_color_space_; }
...
const QString &ColorManager::GetReferenceColorSpace() const { return reference_space_; }
...
void ColorManager::GetDefaultLumaCoefs(float *rgb) const { config_->getDefaultLumaCoefs(rgb); }
