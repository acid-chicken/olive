...
ColorValuesTab::ColorValuesTab(QWidget *parent) : QWidget(parent) {
...
Color ColorValuesTab::GetColor() const {
  return Color(red_slider_->GetValue(), green_slider_->GetValue(), blue_slider_->GetValue());
}
...
void ColorValuesTab::SliderChanged() { emit ColorChanged(GetColor()); }
