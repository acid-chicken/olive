...
ViewerDisplayWidget::ViewerDisplayWidget(QWidget *parent)
    : ManagedDisplayWidget(parent), has_image_(false), signal_cursor_color_(false) {}

ViewerDisplayWidget::~ViewerDisplayWidget() { ContextCleanup(); }
...
void ViewerDisplayWidget::ConnectSibling(ViewerDisplayWidget *sibling) {
  connect(this, &ViewerDisplayWidget::LoadedBuffer, sibling, &ViewerDisplayWidget::SetImageFromLoadBuffer,
          Qt::QueuedConnection);
...
void ViewerDisplayWidget::initializeGL() {
  ...
  connect(context(), &QOpenGLContext::aboutToBeDestroyed, this, &ViewerDisplayWidget::ContextCleanup,
          Qt::DirectConnection);
