...
ViewerWindow::ViewerWindow(QWidget *parent) : QWidget(parent, Qt::Window | Qt::WindowStaysOnTopHint) {
...
ViewerDisplayWidget *ViewerWindow::gl_widget() const { return gl_widget_; }
