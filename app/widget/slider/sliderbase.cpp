...
void SliderBase::SetDragMultiplier(const double &d) { drag_multiplier_ = d; }

void SliderBase::SetRequireValidInput(bool e) { require_valid_input_ = e; }

void SliderBase::SetAlignment(Qt::Alignment alignment) { label_->setAlignment(alignment); }
...
bool SliderBase::IsDragging() const { return dragged_; }
...
void SliderBase::ForceLabelUpdate() { UpdateLabel(Value()); }
...
double SliderBase::AdjustDragDistanceInternal(const double &start, const double &drag) { return start + drag; }

QString SliderBase::ValueToString(const QVariant &v) { return v.toString(); }
