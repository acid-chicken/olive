...
IntegerSlider::IntegerSlider(QWidget *parent) : SliderBase(kInteger, parent) {
  connect(this, SIGNAL(ValueChanged(QVariant)), this, SLOT(ConvertValue(QVariant)));
}

int64_t IntegerSlider::GetValue() { return Value().toLongLong(); }

void IntegerSlider::SetValue(const int64_t &v) { SliderBase::SetValue(QVariant::fromValue(v)); }
...
void IntegerSlider::ConvertValue(QVariant v) { emit ValueChanged(v.toInt()); }
