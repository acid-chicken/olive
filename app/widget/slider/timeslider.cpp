...
TimeSlider::TimeSlider(QWidget *parent) : IntegerSlider(parent) { SetMinimum(0); }
...
QString TimeSlider::ValueToString(const QVariant &v) {
  ...
  return Timecode::timestamp_to_timecode(v.toLongLong(), timebase_, Timecode::CurrentDisplay());
}
