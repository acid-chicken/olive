...
TimelineViewBlockItem::TimelineViewBlockItem(QGraphicsItem *parent) : TimelineViewRect(parent), block_(nullptr) {
  setBrush(Qt::white);
  setCursor(Qt::DragMoveCursor);
}

Block *TimelineViewBlockItem::block() { return block_; }
