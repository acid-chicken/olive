...
rational TimelineViewBase::GetPlayheadTime() const { return Timecode::timestamp_to_time(playhead_, timebase()); }
...
const QGraphicsView::DragMode &TimelineViewBase::GetDefaultDragMode() const { return default_drag_mode_; }
...
void TimelineViewBase::SetEndTime(const rational &length) { end_item_->SetEndTime(length); }
