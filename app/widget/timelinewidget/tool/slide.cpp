...
TimelineWidget::SlideTool::SlideTool(TimelineWidget* parent) : PointerTool(parent) {
...
rational TimelineWidget::SlideTool::FrameValidateInternal(rational time_movement,
...
void TimelineWidget::SlideTool::InitiateGhosts(TimelineViewBlockItem* clicked_item, Timeline::MovementMode trim_mode,
