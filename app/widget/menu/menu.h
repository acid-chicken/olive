...
class Menu : public QMenu {
 public:
  ...
  QAction* AddActionWithData(const QString& text, const QVariant& data, const QVariant& compare);
  ...
  static void ConformItem(QAction* a, const QString& id, const QString& key = QString());
