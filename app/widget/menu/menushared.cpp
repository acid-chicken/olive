...
MenuShared::MenuShared() {
  ...
  edit_paste_insert_item_ =
      Menu::CreateItem(this, "pasteinsert", this, &MenuShared::PasteInsertTriggered, "Ctrl+Shift+V");
  ...
  edit_ripple_delete_item_ =
      Menu::CreateItem(this, "rippledelete", this, &MenuShared::RippleDeleteTriggered, "Shift+Del");
  ...
  clip_add_default_transition_item_ =
      Menu::CreateItem(this, "deftransition", this, &MenuShared::DefaultTransitionTriggered, "Ctrl+Shift+D");
  ...
  clip_enable_disable_item_ =
      Menu::CreateItem(this, "enabledisable", this, &MenuShared::EnableDisableTriggered, "Shift+E");
...
void MenuShared::NestTriggered() { qDebug() << "FIXME: Stub"; }

void MenuShared::DefaultTransitionTriggered() { qDebug() << "FIXME: Stub"; }
