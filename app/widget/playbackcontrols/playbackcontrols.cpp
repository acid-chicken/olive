...
void PlaybackControls::SetTime(const int64_t& r) { cur_tc_lbl_->SetValue(r); }
...
void PlaybackControls::SetEndTime(const int64_t& r) {
  ...
  end_tc_lbl_->setText(Timecode::timestamp_to_timecode(end_time_, time_base_, Core::instance()->GetTimecodeDisplay()));
}
