...
class NodeParamInsertKeyframeCommand : public UndoCommand {
 public:
  ...
  NodeParamInsertKeyframeCommand(NodeInput* input, NodeKeyframePtr keyframe, bool already_done,
...
class NodeParamSetKeyframeTimeCommand : public UndoCommand {
 public:
  ...
  NodeParamSetKeyframeTimeCommand(NodeKeyframePtr key, const rational& new_time, const rational& old_time,
                                  QUndoCommand* parent = nullptr);
...
class NodeParamSetKeyframeValueCommand : public UndoCommand {
 public:
  ...
  NodeParamSetKeyframeValueCommand(NodeKeyframePtr key, const QVariant& new_value, const QVariant& old_value,
                                   QUndoCommand* parent = nullptr);
...
class NodeParamSetStandardValueCommand : public UndoCommand {
 public:
  ...
  NodeParamSetStandardValueCommand(NodeInput* input, int track, const QVariant& new_value, const QVariant& old_value,
                                   QUndoCommand* parent = nullptr);
