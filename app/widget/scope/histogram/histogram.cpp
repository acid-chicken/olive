...
HistogramScope::HistogramScope(QWidget* parent) : ManagedDisplayWidget(parent), buffer_(nullptr) {
...
void HistogramScope::ColorProcessorChangedEvent() { StartUpdate(); }
...
HistogramScopeWorker::HistogramScopeWorker() : cancelled_(false) {}
