...
WaveformScope::WaveformScope(QWidget* parent) : ManagedDisplayWidget(parent), buffer_(nullptr) {
...
void WaveformScope::paintGL() {
...

  {
    ...
    pipeline_->setUniformValue("waveform_dims", waveform_dim_x, waveform_dim_y);
    ...
    pipeline_->setUniformValue("waveform_region", waveform_start_dim_x, waveform_start_dim_y, waveform_end_dim_x,
                               waveform_end_dim_y);
    ...
    pipeline_->setUniformValue("waveform_uv", waveform_start_uv_x, waveform_start_uv_y, waveform_end_uv_x,
                               waveform_end_uv_y);
...
void WaveformScope::UploadTextureFromBuffer() {
  ...
  if (!texture_.IsCreated() || texture_.width() != buffer_->width() || texture_.height() != buffer_->height() ||
