...
void TimeBasedWidget::UpdateMaximumScroll() {
  ...
  foreach (TimelineViewBase *base, timeline_views_) { base->SetEndTime(length); }
...
void TimeBasedWidget::ConnectTimelineView(TimelineViewBase *base) { timeline_views_.append(base); }
