...
TimeBasedWidget::TimeBasedWidget(bool ruler_text_visible, bool ruler_cache_status_visible, QWidget *parent)
    : QWidget(parent), viewer_node_(nullptr), auto_max_scrollbar_(false) {
...
QScrollBar *TimeBasedWidget::scrollbar() const { return scrollbar_; }
...
void TimeBasedWidget::SetScale(const double &scale) { TimelineScaledObject::SetScale(scale); }

void TimeBasedWidget::ZoomIn() { SetScale(GetScale() * 2); }

void TimeBasedWidget::ZoomOut() { SetScale(GetScale() * 0.5); }
