...
AudioOutputDeviceProxy::AudioOutputDeviceProxy() : device_(nullptr), send_averages_(false) {}

void AudioOutputDeviceProxy::SetParameters(const AudioRenderingParams &params) { params_ = params; }
...
void AudioOutputDeviceProxy::SetSendAverages(bool send) { send_averages_ = send; }
